...
\node[draw=ethdarkblue, fill=ethdarkblue!5, rounded corners=5pt, line width=1pt,
  ...
  {\normalsize\bfseries\color{ethdarkblue} THE PHYSICAL AI CO-DESIGN MATRIX}\\[2pt]
...
% ---------- Column headers ----------
\node[colhead] at (0,-0.82) {{\scriptsize\bfseries\color{ethblue}C1 Time \&\\Freshness}};
\node[colhead] at (1,-0.82) {{\scriptsize\bfseries\color{ethbronze}C2 Inertia \&\\Stopping}};
\node[colhead] at (2,-0.82) {{\scriptsize\bfseries\color{harvardcrimson}C3 Actuation\\Limits}};
\node[colhead] at (3,-0.82) {{\scriptsize\bfseries\color{ethpurple}C4 Energy \&\\Thermal}};
\node[colhead] at (4,-0.82) {{\scriptsize\bfseries\color{ethpetrol}C5 Silicon\\Determinism}};
