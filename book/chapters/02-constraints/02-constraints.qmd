...
* **Archetype 1 (Mobility):** Silicon determinism isolates navigation models from sensory ingestion bursts. When autonomous rovers or drones ingest simultaneous multi-view RGB and depth streams, hardware QoS ensures that camera DMA transactions cannot stall the NPU during obstacle avoidance inference.
