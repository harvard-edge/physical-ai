...
5. **Silicon & Micro-architectural Determinism:** The physical computing substrate itself, governed by shared UMA memory crossbar contention, bus quality-of-service (QoS) priorities, and compile-time static SRAM where dynamic heap allocation is strictly forbidden (`malloc = 0`).
