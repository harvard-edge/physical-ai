...
1. **Geometric Reconstruction:** Transforming unprojected 2D pixel coordinates into calibrated 3D Euclidean coordinates using camera intrinsic matrices and extrinsic transformations.
2. **Affordance Tokenization:** Segmenting actionable surfaces, estimating metric object bounding volumes, and predicting continuous surface normal vectors for candidate grasp or contact locations.
...
The 9 stations of dataflow group naturally into five primary horizontal work dimensions that form the rows of the Physical AI Co-Design Matrix (@tbl-five-cognitive-rows):
