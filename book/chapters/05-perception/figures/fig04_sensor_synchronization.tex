...
% Timeline Axis
  ...
  \node[anchor=west, font=\scriptsize\bfseries\color{ethblue}] at (0, -1.15in) { Camera (30 Hz RGB-D):};
  ...
  \node[anchor=west, font=\scriptsize\bfseries\color{ethpetrol}] at (0, -2.60in) { IMU (1000 Hz SPI):};
