...
\begin{tikzpicture}[
  ...
  \node[card, fill=navyfill, draw=structuralnavy, text width=7.5in, align=left] (header) {
    \textbf{\color{structuralnavy} DERIVATIVE CONTINUITY $\mathcal{C}^2$ VS. DISCONTINUOUS WAYPOINT STEPPING} \hfill {\scriptsize\color{neutralgray} Actuator Protection \& Gearbox Shock Mitigation}
  };
