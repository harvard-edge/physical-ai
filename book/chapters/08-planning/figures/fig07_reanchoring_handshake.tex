...
\begin{tikzpicture}[
  ...
  \node[card, fill=navyfill, draw=structuralnavy, text width=7.5in, align=left] (header) {
    \textbf{\color{structuralnavy} ASYNCHRONOUS STATE RE-ANCHORING HANDSHAKE} \hfill {\scriptsize\color{neutralgray} SRAM Mailbox $\cdot$ VETO Interlock $\cdot$ Anti-Windup Protocol}
  };
