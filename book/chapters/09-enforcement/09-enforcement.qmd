...
## Introduction: Real-Time Safety Enforcement and the Proposal–Permission Split
...
![**The 6-DoF Articulated Manipulator Testbed.** Highlighting the specific harmonic drive wrist joint that fractured during the collision incident when an operating system dirty page writeback caused a $140\text{ ms}$ scheduling stall.](figures/fig08_manipulator_arm_cropped.jpg){#fig-enforcement-platform width=100%}
