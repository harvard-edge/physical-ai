...
\begin{tikzpicture}[
  ...
  % --- LEFT CARD CONTAINER ---
  \node[draw=cardborder, fill=cardbg, rounded corners=5pt, line width=0.8pt, text width=4.65in, minimum height=5.20in, inner sep=10pt, anchor=north west] (card_left) at (0, 0) {};
  ...
  \node[draw=cardborder, fill=cardbg, rounded corners=5pt, line width=0.8pt, text width=4.65in, minimum height=5.20in, inner sep=10pt, right=0.30in of card_left.north east, anchor=north west] (card_right) {};
  ...
  \coordinate (Rcenter) at ($(card_right.north)+(0, -3.05in)$);
  ...
  \coordinate (u_orig) at ($(Rcenter)+(-1.20in, 0.35in)$);
  ...
  \coordinate (u_prop) at ($(Rcenter)+(0.55in, 1.25in)$);
  ...
  \coordinate (u_proj) at ($(Rcenter)+(0.55in, 0.95in)$);
  ...
  \node[font=\sffamily\bfseries\scriptsize, text=measuredTeal] at ($(Rcenter)+(-0.90in, 0.65in)$) {
     $\mathcal{U}_{\text{safe}}(x)$ (Permitted Action Space)
  };
  \node[font=\sffamily\bfseries\scriptsize, text=consequenceCoral] at ($(Rcenter)+(-0.90in, 1.20in)$) {
     Forbidden (Breaches Invariant)
  };

  % Performance Summary Badge
  \node[draw=ethdarkblue!30, fill=white, rounded corners=3pt, font=\sffamily\scriptsize, text=ethdarkblue, inner sep=3.5pt] at ($(Rcenter)+(0, 0.00in)$) {
