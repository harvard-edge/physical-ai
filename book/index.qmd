# Physical AI Systems {.unnumbered}

::: {.hero-banner}
**Machine Learning Systems That Sense and Act**  
*A Systems Engineering Discipline for Machines That Move Matter and Energy*

**Prof. Vijay Janapa Reddi**  
Harvard University $\cdot$ ETH Zurich  
*Course Syllabus $\cdot$ Open Reference Manuscript $\cdot$ Arduino Dual-Brain Kit $\cdot$ 13 Bench Labs*
:::

---

## The Course & Book Portal

Welcome to **Physical AI Systems** ([`physical.mlsysbook.ai`](https://physical.mlsysbook.ai)). This curriculum is an open, backward-designed engineering discipline for building, measuring, constraining, and qualifying learned machine learning systems that exercise delegated physical authority over matter and energy.
...
::: {.g-col-12 .g-col-md-6}
::: {.callout-important title="📋 Course Syllabus & Schedule" icon=false}
...
* **The Conceptual Framework:** **The Anatomy of a Physical Agent** (the universal systems organs: Perception $\to$ Memory $\to$ Reasoning $\to$ Planning $\to$ Reflex $\to$ Governance).
...
| The Conceptual Framework<br>*(The Anatomy of a Physical Agent)* | The Reference Hardware Realization<br>*(The Physical Agent on the Physical AI Kit)* | Dossier Artifact Produced |
| :--- | :--- | :---: |
| **1. Physical Causality** | Actuator power bus isolation and hardware emergency stop loop | `LOOP-01` |
| **2. Time and Latency** | Hardware ingestion, PTP timestamps, and complete-path $P_{99}$ latency profiler | `REQ-01` |
| **3. Multi-Rate Systems** | Dual-Brain lock-free IPC skeleton (Linux MPU $\leftrightarrow$ FreeRTOS MCU) | `RUN-01` |
| **4. Perception** | Edge NPU spatial vision and contact encoder tokenizers | `OBS-01` |
| **5. Memory** | 3D dynamic coordinate frame graph ($SE(3)$) and state validity TTL leases | `STATE-01` |
| **6. Reasoning** | MPU VLM spatial bounding boxes and expiring intent leases ($t_{\text{expire}}$) | `INTENT-01` |
| **7. Planning** | MPU VLA multi-step action chunk unrolling ($H$-steps) and $\mathcal{C}^2$ ensembling | `PLAN-01` |
| **8. Reflex** | Dedicated MCU bare-metal 1 kHz safety enforcer and dynamic stopping bounds ($d_{\text{stop}}$) | `ENF-01` |
| **9. Placement** | Whole-system heterogeneous resource ledger (FLOPs, SRAM, Watts, bus QoS) | `PLACE-01` |
| **10. Governance** | Bumpless joystick override state machine and cryptographic provenance logger | `AUTH-01` |
| **11. Release** | Cross-layer injected seeded fault defense and CAE safety case | `REL-01` |
| **12. Capstone** | Live unannounced seeded fault defense and Capstone certification | **Final Release** |
