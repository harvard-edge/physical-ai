...
![The Evolutionary Arc of Machine Learning Systems: From disembodied cloud models and edge micro-detectors to multimodal foundation models and Physical AI closing the real-time loop over matter and energy.](chapters/01-boundary/figures/fig01_eras_evolution.pdf){#fig-eras-preface width=100%}
...
![The Three Engineering Tribes and the Physical AI Systems Synthesis: Unifying the Brain (Machine Learning), the Nervous System (Embedded Systems), and the Body (Robotics and Control) across the Proposal--Permission Boundary.](chapters/01-boundary/figures/fig01_three_tribes.pdf){#fig-tribes-preface width=100%}
...
## Concept vs. Realization: The Anatomy and The TinyAgent

The curriculum connects platform-neutral theory to tangible, zero-magic bench hardware:

* **The Conceptual Framework:** **The Anatomy of a Physical AI Agent** (the universal systems organs: Perception $\to$ Memory $\to$ Reasoning $\to$ Planning $\to$ Reflex $\to$ Governance).
* **The Reference Hardware Realization:** **The TinyAgent on the Arduino UNO Q Dual-Brain Kit** (Linux MPU + Real-Time MCU).

| The Conceptual Framework<br>*(The Anatomy of a Physical AI Agent)* | The Reference Hardware Realization<br>*(The TinyAgent on Arduino UNO Q Dual-Brain)* | Dossier Artifact Produced |
| :--- | :--- | :---: |
