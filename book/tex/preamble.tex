...
\addtokomafont{headsepline}{\color{paleink!70}}

\renewcommand*{\chaptermarkformat}{}
\renewcommand*{\sectionmarkformat}{}

\setkomafont{pagehead}{\normalfont\sffamily\fontsize{7.8pt}{9.8pt}\selectfont\color{softink}}
\setkomafont{pagenumber}{\normalfont\sffamily\bfseries\fontsize{8.5pt}{10.5pt}\selectfont\color{structural}}

\makeatletter
\renewcommand*{\chaptermark}[1]{%
  \begingroup
    \let\chaptersubtitle\@gobble
    \let\newline\space
    \unrestored@protected@xdef\@gtempa{#1}%
  \endgroup
  \markboth{\@gtempa}{}%
}
...
% Verso (even / left) header: Outer page number, Inner chapter title
\lehead{\pagemark\hspace{1.2em}{\color{paleink!70}\rule[-0.2ex]{0.4pt}{1.2ex}}\hspace{1.2em}\leftmark}
\rehead{}

% Recto (odd / right) header: Inner section title, Outer page number
\lohead{}
\rohead{\rightmark\hspace{1.2em}{\color{paleink!70}\rule[-0.2ex]{0.4pt}{1.2ex}}\hspace{1.2em}\pagemark}
\makeatother
...
\setkomafont{subsubsection}{\normalfont\bfseries\fontsize{9.5pt}{12pt}\selectfont\color{structural}}
\setkomafont{paragraph}{\normalfont\bfseries\fontsize{9pt}{11.5pt}\selectfont\color{structural}}

% Drop caps configuration for chapter openings
\renewcommand{\LettrineFontHook}{\bfseries\color{consequence}}
...
\renewcommand*{\chapterlinesformat}[3]{%
  \vspace*{0.05in}%
  #2%
  {\normalfont\bfseries\fontsize{18pt}{22pt}\selectfont\color{ink}\raggedright #3}\par\nobreak
  \vspace{0.25\baselineskip}%
  \ifiscontentstoc\else
    {\color{consequence}\rule{1.4in}{1.4pt}\hspace{0.4em}\color{paleink!70}\rule{\dimexpr\textwidth-1.4in-0.4em\relax}{0.4pt}}\par
    \vspace{0.20\baselineskip}%
  \fi
}
\RedeclareSectionCommand[beforeskip=0pt,afterskip=0.20\baselineskip]{chapter}

% Part opener: Authoritative architectural movement portal with rich personality
\setkomafont{part}{\normalfont\bfseries\fontsize{22pt}{26pt}\selectfont\color{ink}\raggedright}
\setkomafont{partnumber}{\normalfont\sffamily\bfseries\fontsize{10.5pt}{13pt}\selectfont\color{consequence}}
\renewcommand*{\partformat}{%
  {\usekomafont{partnumber}\MakeUppercase{Part~\thepart}}\par
  \vspace{0.25\baselineskip}%
}

\renewcommand*{\partheadstartvskip}{\vspace*{0.25in}}
\renewcommand*{\partheadmidvskip}{\par\nobreak\vspace{0.30\baselineskip}}
\renewcommand*{\partheadendvskip}{\par\nobreak\vspace{0.25\baselineskip}}

\makeatletter
% Prevent \part from forcing a trailing blank page, rendering the Part title rule and essay directly on the opener spread
\def\@endpart{%
  \par\nobreak\vspace{0.20\baselineskip}%
  {\color{consequence}\rule{1.8in}{1.8pt}\hspace{0.4em}\color{paleink!70}\rule{\dimexpr\textwidth-1.8in-0.4em\relax}{0.6pt}}\par
...
% Ensure section numbers include chapter number prefix (e.g. 1.1, 1.2)
...
% Patch \tableofcontents to guarantee Crimson "Contents" heading without underline and suppress subtitles
...
\newcommand{\numbered@chapter}[2][]{%
  ...
  \fi
  \ifnum\value{chapter}=16
    \ifsynthesiswritten\else
      \addtocontents{toc}{\protect\tocdivisionentry{Synthesis}}%
      \global\synthesiswrittentrue
    \fi
  \fi
  ...
  \if\relax\detokenize{#1}\relax
    ...
    \markboth{Chapter~\thechapter\hspace{0.8em}\@gtempa}{}%
...
\renewcommand*{\l@chapter}[2]{%
  \ifnum \c@tocdepth >\m@ne
    ...
    {%
      ...
      \leavevmode
      \begingroup
        \renewcommand{\numberline}[1]{{\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{ink}\format@toc@number{##1}\hspace{0.55em}}}%
        {\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{ink}#1}\nobreak
      \endgroup
      \TOCLineLeaderFill
      \nobreak
      {\normalfont\sffamily\bfseries\fontsize{8.8pt}{11.5pt}\selectfont\color{ink}#2}%
      \par
    }%
  \fi
}
  ...
  \ifnum \c@tocdepth >\z@
    ...
    {%
      ...
      \begingroup
        ...
        {\normalfont\sffamily\fontsize{8.0pt}{10.2pt}\selectfont\color{softink}#1}\nobreak
      \endgroup
      \TOCLineLeaderFill
      \nobreak
      {\normalfont\sffamily\fontsize{8.0pt}{10.2pt}\selectfont\color{softink}#2}%
      \par
    }%
  \fi
}
...
% Clean, compact tables with alternating subtle row tints
\AtBeginEnvironment{longtable}{%
  \fontsize{7.5pt}{9.6pt}\selectfont%
  \setlength{\tabcolsep}{3.8pt}%
  \renewcommand{\arraystretch}{1.18}%
  \rowcolors{2}{white}{cardbg}%
}
