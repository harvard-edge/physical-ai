...
\renewcommand{\LettrineFontHook}{\bfseries\color{structural}}
...
% Floats: Always prefer top of the page (academic textbook standard)
\makeatletter
\def\fps@figure{tp}
\def\fps@table{tp}
\makeatother
...
\renewcommand{\bottomfraction}{0.0}     % prevent bottom floats entirely
\renewcommand{\textfraction}{0.15}      % min fraction of page for text
\renewcommand{\floatpagefraction}{0.70} % min fraction of float page occupied
