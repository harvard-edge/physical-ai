...
\setkomafont{section}{\normalfont\bfseries\fontsize{11.5pt}{14pt}\selectfont\color{ink}}
\setkomafont{subsection}{\normalfont\bfseries\fontsize{10pt}{12.5pt}\selectfont\color{ink}}
...
\renewcommand*{\marginfont}{%
  \normalfont\sffamily\fontsize{6.6pt}{8.4pt}\selectfont\color{softink}\raggedright}
\setkomafont{footnote}{%
  \normalfont\sffamily\fontsize{6.6pt}{8.4pt}\selectfont\color{softink}}
\setkomafont{footnotemark}{%
  \normalfont\sffamily\bfseries\fontsize{6.6pt}{8.4pt}\selectfont\color{consequence}}
  ...
  \IfNoValueOrEmptyTF{#1}%
    {%
      \@sidenotes@placemarginal{#2}{%
        \normalfont\sffamily\fontsize{6.6pt}{8.4pt}\selectfont\color{softink}%
        {\bfseries\color{consequence}\textsuperscript{\thesidenote}}\hspace{0.25em}%
        {\let\footnotesize\relax\raggedright #3}%
      }%
    ...
    {%
      \@sidenotes@placemarginal{#2}{%
        \normalfont\sffamily\fontsize{6.6pt}{8.4pt}\selectfont\color{softink}%
        {\bfseries\color{consequence}\textsuperscript{#1}}\hspace{0.25em}%
        {\let\footnotesize\relax\raggedright #3}%
      }%
    }%
}
...
{%
  ...
  \ifhmode
      ...
      \nobreak
  \fi
  \hbox {\textsuperscript{\normalfont\sffamily\bfseries\fontsize{6.6pt}{8.4pt}\selectfont\color{consequence}#1}}%
  \ifhmode
      \spacefactor \@x@sf
  \fi
  \relax
