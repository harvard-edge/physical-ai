...
% Prevent awkward mid-table splits: require at least 38 baselines of vertical space
% before starting a longtable, automatically pushing tables to the top of the next page
\BeforeBeginEnvironment{longtable}{%
  \par\penalty0\Needspace*{38\baselineskip}%
