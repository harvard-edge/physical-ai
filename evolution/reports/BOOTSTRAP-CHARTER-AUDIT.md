...
| Evolution ledger | hash-chain ledger, validated `ExperimentRecord`, replay binding, and final-state controller integration | partial | persist records through every controller transition and prove observation-to-PR lineage |
