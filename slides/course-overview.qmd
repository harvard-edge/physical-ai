...
* **Digital ML ends at digital output:**
  * Classifiers emit labels; LLMs emit text.
  * Errors are safely isolated: exceptions are caught, dropped packets retry, transactions roll back.
* **Physical AI Systems begin when software moves matter:**
  * Commands inverter MOSFETs, accelerates kilograms of mass, consumes energy, and interacts with humans.
* **The Irreversibility Law:**
  * **You cannot `ctrl+z` kinetic momentum or Joule heat ($I^2R$).**
:::

::: {.column width="40%"}
::: {.callout-note icon=false title="The Central Systems Question"}
...
::: {.callout-tip title="The Desk Bench Twin: Arduino UNO Q Dual-Brain Kit"}
...
![The 20 Systems Friction Points: Crossing the 5 Cognitive Stages (the rows) against the 4 Physical Constraint Columns.](figures/fig01_codesign_matrix.svg){width="95%"}
